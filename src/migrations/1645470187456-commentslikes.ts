...
export class commentslikes1645470187456 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "commentslikes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userid" character varying NOT NULL, "commentid" character varying NOT NULL, "user_id" uuid, "comment_id" uuid, CONSTRAINT "PK_40f6fd1514156b8d7801c802071" PRIMARY KEY ("id"))`);
